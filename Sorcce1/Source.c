...
int main(void)
{
	...
	while (1) {
		...
		if (sty == 2 && stx == 2 ) { printf("初期配置\n"); }
		if (sty == 2 && stx ==10 ) { printf("武器1\n"); }
		if (sty == 10 && stx ==10) { printf("武器2\n"); }
		if (sty == 18 && stx == 2) { printf("武器3\n"); }
		if (sty == 6 && stx == 6) { printf("敵1\n"); }
		if (sty == 2 && stx == 14) { printf("敵2\n"); }
		if (sty == 10 && stx == 14) { printf("敵3\n"); }
		if (sty == 10 && stx == 18) { printf("敵4\n"); }
		if (sty == 14 && stx == 10) { printf("敵5\n"); }
		if (sty == 14 && stx == 14) { printf("敵6\n"); }
		if (sty == 18 && stx == 18) { printf("ボス\n"); }
